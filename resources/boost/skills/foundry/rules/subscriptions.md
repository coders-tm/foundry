...
## Core Models & Traits
- **Trait**: `Foundry\Traits\Billable` — Must be used on the User model.
- **Trait**: `Foundry\Traits\ManagesSubscriptions` — Handles the higher-level subscription logic.
...
- **Trait**: `Foundry\Traits\HasFeature` — Check and track usage.
