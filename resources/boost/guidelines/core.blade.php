...
Refund, WalletBalance, Blog, Admin, Currency, Settings (Facade), PaymentMethod, ExchangeRate, SupportTicket,
AutoRenewal, ManagesSubscriptions, Billable, HasWallet, HasFeature, HasPermission, Foundry facade, auth guards, or
any artisan command prefixed with `check:`, `subscriptions:`, `reset:`, `update:`, or `migrate:`.
...
- IMPORTANT: Use `Currency::format()`, `format_currency()`, `settings()`, `user()`, `is_admin()`, and `app_url()` helpers rather than
raw Laravel equivalents — they handle multi-guard, multi-currency, and file-based settings context correctly.
