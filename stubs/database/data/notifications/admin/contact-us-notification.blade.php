<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">We have received a new
                submission through the contact form. Here are the details:</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin: 36px 0;">
                <tr>
                    <td align="center">
                        <a href="{{ $enquiry->admin_url }}" target="_blank" rel="noopener"
                ...
                <tr>
                    <td style="padding: 20px 0 0;">
                        <p style="margin: 0; font-size: 12px; line-height: 18px; color: #94a3b8;">
                            ...
                            <span
                                style="display: block; margin-top: 6px; word-break: break-all; color: #003D99;">{{ $enquiry->admin_url }}</span>
                        </p>
                    </td>
                </tr>
            </table>
