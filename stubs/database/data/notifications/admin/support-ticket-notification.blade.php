    ...
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p
                ...
                🎫 New Support Ticket</p>

            <p style="margin: 0 0 20px; font-size: 16px; line-height: 26px; color: #334155;">
                Hi,
            </p>

            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">A new support ticket has
                been submitted and requires attention.</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                @if ($support_ticket->user && $support_ticket->user->name)
                    <tr>
                        <td
                            style="padding: 13px 18px; border-bottom: 1px solid #e2e8f0; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.06em; width: 38%;">
                            Submitted By</td>
                        <td
                            ...
                            {{ $support_ticket->user->name }}</td>
                    </tr>
                @endif
                @if ($support_ticket->user && $support_ticket->user->email)
                    <tr>
                        <td
                            style="padding: 13px 18px; border-bottom: 1px solid #e2e8f0; font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.06em; width: 38%;">
                            Email</td>
            ...
            <!-- Attachments -->
            @if (count($support_ticket->attachments ?? []))
                <p
