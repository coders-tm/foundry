<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">Your subscription expired on
                <span style="color: #dc2626; font-weight: 600;">{{ $expires_at }}</span>.
            </p>
                ...
                <tbody>
                    ...
                    <tr>
                        <td
                            ...
                            Expired On</td>
                        <td
                            style="padding: 13px 18px; font-size: 14px; color: #dc2626; text-align: right; white-space: nowrap; font-weight: 600;">
                            {{ $expires_at }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <!-- Danger Panel -->
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                style="background-color: #fee2e2; border: 1px solid #fecaca; border-radius: 8px; margin-bottom: 24px;">
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #991b1b;">❌ As your subscription
                            has ended, you no longer have access to premium features. We hope you enjoyed your time with
                            us!</p>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">Questions? Contact us
                            at <a href="mailto:{{ $app->email }}"
