    ...
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p
                ...
                🚀 Subscription Upgraded</p>

            <p style="margin: 0 0 20px; font-size: 16px; line-height: 26px; color: #334155;">
                Hi <strong style="color: #0f172a;">{{ $user->first_name }}</strong>,
            </p>

            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">Congratulations! Your
                subscription has been upgraded successfully.</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #166534;">✨ Thank you for
                            upgrading! We're excited to have you on your new plan with enhanced features and benefits.
                        </p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">Questions about your
                            upgrade? Contact us at <a href="mailto:{{ $app->email }}"
