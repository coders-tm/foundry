<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">We're sorry to inform you
                that your payment for order <strong style="color: #0f172a;">{{ $order->number }}</strong> could not be
                processed.</p>

            <!-- Danger Panel with Reason -->
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                style="background-color: #fee2e2; border: 1px solid #fecaca; border-radius: 8px; margin-bottom: 24px;">
                <tr>
                    <td style="padding: 16px 20px;">
                        <p
                            style="margin: 0 0 8px; font-size: 12px; font-weight: 700; color: #991b1b; text-transform: uppercase;">
                            Reason for Failure</p>
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #991b1b;">{{ $reason }}
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">If you continue to
                            experience issues, please contact our support team at <a href="mailto:{{ $support->email }}"
