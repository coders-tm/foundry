    ...
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 20px; font-size: 16px; line-height: 26px; color: #334155;">
                Hi <strong style="color: #0f172a;">{{ $user->first_name ?? 'there' }}</strong>,
            </p>

            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">A new reply has been posted
                to your support ticket.</p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                <td
                                    ...
                                    Ticket</td>
                                <td
                                    style="padding: 0; font-size: 13px; font-weight: 700; color: #0f172a; vertical-align: middle;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                <td
                                    style="padding: 0; font-size: 12px; font-weight: 600; color: #64748b; width: 30%; vertical-align: middle;">
                                    Subject</td>
                                <td style="padding: 0; font-size: 13px; color: #334155; vertical-align: middle;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">ℹ️ Reply via the
                            portal for threaded conversation and complete history.</p>
                    </td>
                </tr>
            </table>
