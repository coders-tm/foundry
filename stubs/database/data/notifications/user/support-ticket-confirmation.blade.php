<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">Thanks for contacting us.
                Your ticket has been created and is now in our queue.</p>
            ...
            @if (!empty($support_ticket->message))
                <!-- Section Header -->
                <p
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">ℹ️ We'll notify you
                            when a team member replies. Please do not respond to this email; respond via the portal for
                            fastest support.</p>
                    </td>
                </tr>
            </table>
