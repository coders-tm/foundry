<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">A partial refund has been
                processed for your order <strong style="color: #0f172a;">{{ $order->number }}</strong>.</p>

            <!-- Warning Panel with Amount -->
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                style="background-color: #fef9c3; border: 1px solid #fde68a; border-radius: 8px; margin-bottom: 24px;">
                <tr>
                    <td style="padding: 16px 20px;">
                        <p
                            style="margin: 0 0 8px; font-size: 12px; font-weight: 700; color: #a16207; text-transform: uppercase;">
                            Refund Amount</p>
                        <p style="margin: 0; font-size: 20px; line-height: 28px; font-weight: 800; color: #d97706;">
                            {{ $refund->amount }}</p>
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td
                            ...
                            Refund Amount</td>
                        <td
                            style="padding: 13px 18px; border-bottom: 1px solid #e2e8f0; font-size: 14px; font-weight: 700; color: #d97706; text-align: right;">
                            {{ $refund->amount }}</td>
                    </tr>
                    <tr>
                        <td
            ...
            <!-- Info Panel with Processing Info -->
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; margin-bottom: 24px;">
                <tr>
                    <td style="padding: 16px 20px;">
                        <p
                            style="margin: 0 0 12px; font-size: 12px; font-weight: 700; color: #0c4a6e; text-transform: uppercase;">
                            Processing Time</p>
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">Please allow 5–10
                            business days for the refund to appear in your account, depending on your bank's processing
                            time.</p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">If you have any
                            questions about this refund, please contact us at <a href="mailto:{{ $support->email }}"
