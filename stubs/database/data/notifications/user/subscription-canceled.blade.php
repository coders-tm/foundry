    ...
    <tr>
        <td style="font-size: 15px; line-height: 24px; color: #334155;">
            ...
            <p
                ...
                🛑 Subscription Ended</p>

            <p style="margin: 0 0 20px; font-size: 16px; line-height: 26px; color: #334155;">
                Hi <strong style="color: #0f172a;">{{ $user->first_name }}</strong>,
            </p>

            <p style="margin: 0 0 28px; font-size: 15px; line-height: 24px; color: #334155;">Your subscription ended on
                <strong style="color: #0f172a;">{{ $expires_at ?: $ends_at }}</strong>.
            </p>
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #991b1b;">❌ As your subscription
                            has ended, you no longer have access to premium features.</p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        <p style="margin: 0; font-size: 14px; line-height: 22px; color: #0c4a6e;">Thank you for being a
                            part of our service. We hope to see you again soon! Questions? Contact us at <a
