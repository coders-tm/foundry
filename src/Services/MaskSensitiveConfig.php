...
class MaskSensitiveConfig extends BladeCompiler
{
    ...
    protected $sensitiveKeys = [
        ...
        'foundry.payment-providers.stripe.secret',
        'foundry.payment-providers.stripe.webhook_secret',
        'foundry.payment-providers.paypal.client_secret',
        'foundry.payment-providers.gocardless.access_token',
        'foundry.payment-providers.gocardless.webhook_secret',
        'foundry.payment-providers.razorpay.key_secret',
        'foundry.payment-providers.klarna.api_secret',
        'foundry.payment-providers.mercadopago.access_token',
        'foundry.payment-providers.paystack.secret_key',
        'foundry.payment-providers.xendit.secret_key',
        'foundry.payment-providers.flutterwave.secret_key',
        'foundry.payment-providers.flutterwave.encryption_key',
        'foundry.payment-providers.alipay.private_key',
        'foundry.payment-providers.paddle.api_key',
        'foundry.payment-providers.paddle.client_token',
        'foundry.payment-providers.paddle.webhook_secret',
