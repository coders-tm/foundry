...
class SupportTicketPolicy
{
    ...
    {
        return $admin->canAny(['support-tickets:read', 'support-tickets:write', 'support-tickets:editor']);
    }
    ...
    {
        return $admin->canAny(['support-tickets:write', 'support-tickets:editor']);
    }
    ...
    {
        return $admin->can('support-tickets:write');
    }
