...
trait WithInput
{
    ...
    /**
     * Foundryly the callback if the resource contains the given input item key.
     *
     * @param  string  $key
     * @return $this|mixed
     */
    ...
    /**
     * Foundryly the callback if the resource contains a non-empty value for the given input item key.
     *
     * @param  string  $key
     * @return $this|mixed
     */
