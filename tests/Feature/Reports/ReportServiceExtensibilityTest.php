...
afterEach(function () {
    \Foundry\Services\Reports\ReportService::unregister('test-report');
});
...
class TestReport extends \Foundry\Services\Reports\AbstractReport
{
    public static function getType(): string { return 'test-report'; }
    public function query(array $filters) { return []; }
    public function toRow($row): array { return []; }
}
