...
class InvoiceCalculationTest extends TestCase
{
    ...
    public function test_upcoming_invoice_calculations()
    {
        ...
        $this->assertEquals(80.00, $upcomingInvoice->grand_total, 'Grand total should be correct ($80)');
    }
    ...
    public function test_generated_invoice_calculations()
    {
        ...
        $this->assertEquals(85.00, $invoice->grand_total, 'Stored grand_total should be correct ($85)');
    }
}
