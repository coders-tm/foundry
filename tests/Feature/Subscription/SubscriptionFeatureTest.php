...
it('subscription features are reset when plan is swapped via api route', function () {
    ...
    $basicFeature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'basic-users',
    'label' => 'Basic Users',
    'type' => 'integer',
    ]);
    
    $proFeature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'pro-analytics',
    'label' => 'Pro Analytics',
    'type' => 'boolean',
    ]);
    ...
    $basicPlan = \Foundry\Models\Subscription\Plan::create([
    'label' => 'Basic Plan',
    'price' => 1000, // $10
    'interval' => 'month',
    'interval_count' => 1,
    ...
    $proPlan = \Foundry\Models\Subscription\Plan::create([
    'label' => 'Pro Plan',
    'price' => 5000, // $50
    'interval' => 'month',
    'interval_count' => 1,
...
it('subscription features are reset when downgrading from pro to basic', function () {
    // Create features
    $storageFeature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'storage-gb',
    'label' => 'Storage GB',
    'type' => 'integer',
    ]);
    
    $premiumSupportFeature = \Foundry\Models\Subscription\Feature::factory()->create([
...
it('scheduled downgrade syncs features on renewal', function () {
    // Create features
    $apiCallsFeature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'api-calls',
    'label' => 'API Calls',
    'type' => 'integer',
    ]);
    
    $webhooksFeature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'webhooks',
    'label' => 'Webhooks',
    'type' => 'boolean',
    ]);
...
it('swap subscription syncs feature values from new plan', function () {
    $user = \App\Models\User::factory()->create();
    $planA = \Foundry\Models\Subscription\Plan::factory()->create(['trial_days' => 0]);
    $planB = \Foundry\Models\Subscription\Plan::factory()->create(['trial_days' => 0]);
    
    // Create a feature
    $feature = \Foundry\Models\Subscription\Feature::factory()->create([
    'slug' => 'test-limit',
    'type' => 'integer',
    'resetable' => true,
    'label' => 'Test Limit',
...
it('subscription features are created on subscription creation', function () {
    ...
    $plan = new \Foundry\Models\Subscription\Plan([
    'label' => 'Test Plan',
    'slug' => 'test-plan',
...
it('swap updates billing interval', function () {
    ...
    // Create monthly plan
    $monthlyPlan = \Foundry\Models\Subscription\Plan::create([
    'label' => 'Monthly Plan',
    'price' => 1000,
    'interval' => 'month',
    'interval_count' => 1,
    ...
    // Create yearly plan
    $yearlyPlan = \Foundry\Models\Subscription\Plan::create([
    'label' => 'Yearly Plan',
    'price' => 10000,
    'interval' => 'year',
    'interval_count' => 1,
    ...
    $quarterlyPlan = \Foundry\Models\Subscription\Plan::create([
